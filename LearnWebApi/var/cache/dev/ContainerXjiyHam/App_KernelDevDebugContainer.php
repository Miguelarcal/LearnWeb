...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BlockController' => 'getBlockControllerService',
            'App\\Controller\\CourseController' => 'getCourseControllerService',
            'App\\Controller\\LabelController' => 'getLabelControllerService',
            'App\\Controller\\LanguageController' => 'getLanguageControllerService',
            'App\\Controller\\PageController' => 'getPageControllerService',
            'App\\Controller\\TutorialController' => 'getTutorialControllerService',
            'App\\Controller\\TutorialInCourseController' => 'getTutorialInCourseControllerService',
    ...
    {
        return $container->services['api_platform.symfony.parameter_validator'] = new \ApiPlatform\Symfony\Validator\State\ParameterValidatorProvider(new \ApiPlatform\State\Provider\ParameterProvider(new \ApiPlatform\State\Provider\ReadProvider(($container->privates['api_platform.state_provider.locator'] ?? self::getApiPlatform_StateProvider_LocatorService($container)), ($container->privates['api_platform.serializer.context_builder.filter'] ?? self::getApiPlatform_Serializer_ContextBuilder_FilterService($container))), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C75uNVHEFQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ApiResourceRepository' => ['privates', 'App\\Repository\\ApiResourceRepository', 'getApiResourceRepositoryService', true],
            'App\\Repository\\BlockRepository' => ['privates', 'App\\Repository\\BlockRepository', 'getBlockRepositoryService', true],
            'App\\Repository\\CourseRepository' => ['privates', 'App\\Repository\\CourseRepository', 'getCourseRepositoryService', true],
            'App\\Repository\\LabelRepository' => ['privates', 'App\\Repository\\LabelRepository', 'getLabelRepositoryService', true],
            ...
            'App\\Repository\\TutorialInCourseRepository' => ['privates', 'App\\Repository\\TutorialInCourseRepository', 'getTutorialInCourseRepositoryService', true],
            'App\\Repository\\TutorialRepository' => ['privates', 'App\\Repository\\TutorialRepository', 'getTutorialRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\ApiResourceRepository' => '?',
            ...
            'App\\Repository\\TutorialInCourseRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\BlockController', 'App\\Controller\\CourseController', 'App\\Controller\\LabelController', 'App\\Controller\\LanguageController', 'App\\Controller\\PageController', 'App\\Controller\\TutorialController', 'App\\Controller\\TutorialInCourseController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zq-6okyy-z', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6GviHlASru', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OIemAnAUn3', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getApiPlatform_Listener_Request_DeserializeService($container)
    {
        ...
        return $container->privates['api_platform.listener.request.deserialize'] = new \ApiPlatform\Symfony\EventListener\DeserializeListener(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\State\Provider\DeserializeProvider(NULL, $a, ($container->privates['api_platform.serializer.context_builder.filter'] ?? self::getApiPlatform_Serializer_ContextBuilder_FilterService($container)), NULL), $b, 'post_denormalize'), ($container->privates['api_platform.metadata.resource.metadata_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_CachedService($container)));
    }
    ...
    protected static function getApiPlatform_Listener_Request_ReadService($container)
    {
        ...
        return $container->privates['api_platform.listener.request.read'] = new \ApiPlatform\Symfony\EventListener\ReadListener(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Bundle\SwaggerUi\SwaggerUiProvider(($container->services['api_platform.symfony.parameter_validator'] ?? self::getApiPlatform_Symfony_ParameterValidatorService($container)), ($container->privates['api_platform.openapi.factory'] ?? self::getApiPlatform_Openapi_FactoryService($container))), $a), ($container->privates['api_platform.metadata.resource.metadata_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_CachedService($container)), NULL, ($container->privates['api_platform.uri_variables.converter'] ?? self::getApiPlatform_UriVariables_ConverterService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O8LoOiNOxU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $q = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $f, $b, $c, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n), NULL);
